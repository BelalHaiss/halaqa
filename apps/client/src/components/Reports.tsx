        ...
        <div className='overflow-x-auto'>
          <table className='w-full min-w-[640px]'>
            <thead className='bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700'>
              <tr>
                <th className='text-right px-3 md:px-4 py-3 text-xs text-gray-700 dark:text-gray-300'>
                  الطالب
                </th>
                <th className='text-right px-3 md:px-4 py-3 text-xs text-gray-700 dark:text-gray-300'>
                  الحلقة
                </th>
                <th className='text-center px-2 md:px-4 py-3 text-xs text-gray-700 dark:text-gray-300'>
                  حضر
                </th>
                <th className='text-center px-2 md:px-4 py-3 text-xs text-gray-700 dark:text-gray-300'>
                  تأخر
            ...
            <tbody>
              {sortedStats.map((student) => (
                ...
                >
                  <td className='px-3 md:px-4 py-3 text-sm text-gray-800 dark:text-gray-100'>
                    {student.name}
                  </td>
                  <td className='px-3 md:px-4 py-3 text-xs text-gray-600 dark:text-gray-400'>
                    {student.groupName}
                  </td>
                  <td className='px-2 md:px-4 py-3 text-center text-sm text-gray-800 dark:text-gray-100'>
                    {student.attended}
                  </td>
                  <td className='px-2 md:px-4 py-3 text-center text-sm text-gray-800 dark:text-gray-100'>
                    {student.late}
