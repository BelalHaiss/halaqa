...
interface CreateGroupModalProps {
  ...
  onClose: () => void;
  user?: User;
  onCreateGroup?: (group: CreateGroupDto) => Promise<{ success: boolean } | void> | void;
}
...
export default function CreateGroupModal({
  ...
  const confirmCreate = async () => {
    ...
    const scheduleDays = selectedDays.map((dayOfWeek) => ({
      dayOfWeek,
      startMinutes: timeToStartMinutes(time),
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        title='تأكيد إنشاء الحلقة'
        description='هل تريد إنشاء الحلقة بهذه البيانات؟'
        confirmText='إنشاء'
        cancelText='إلغاء'
        variant='solid'
        color='primary'
