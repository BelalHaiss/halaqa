...
export const SESSION_STATUS_CONFIG: Record<SessionComputedStatus, SessionStatusConfig> = {
...
export const getSessionStatusConfig = (status: SessionComputedStatus): SessionStatusConfig => {
...
export const ATTENDANCE_STATUS_CONFIG: Record<AttendanceStatus, AttendanceStatusConfig> = {
...
export const getAttendanceStatusConfig = (status: AttendanceStatus): AttendanceStatusConfig => {
